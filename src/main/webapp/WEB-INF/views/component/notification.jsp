...
noti2.put("imageUrl",
		"https://thumbnail7.coupangcdn.com/thumbnails/remote/492x492ex/image/vendor_inventory/e191/98384687d5d12e3ea89d40aa5e2dbde706966b7e813caccd8e7d58a0f310.jpg");
...
noti3.put("imageUrl",
		"http://gd3.alicdn.com/imgextra/i3/54410696/TB2vkTrbrMlyKJjSZFlXXbMoFXa_!!54410696.jpg_640x640.jpg");
...
<body>
	...
	<div class="offcanvas offcanvas-end" tabindex="-1"
		...
		<div class="offcanvas-body p-0">
			...
			%>
			<div
				class="notification-item position-relative <%=((Boolean) noti.get("isNew")) ? "is-new" : ""%>"
				id="notification-<%=noti.get("id")%>">
				<img src="<%=noti.get("imageUrl")%>" alt="상품 이미지">

				<div class="notification-content">
					<p>
						<strong>[<%=noti.get("productName")%>]
						</strong>
						<%=noti.get("message")%>
					</p>
				</div>
				...
				<button type="button" class="btn-close ms-2" aria-label="Close"
					onclick="dismissNotification(event, <%=noti.get("id")%>)"></button>
