		...
		<div class="row row-cols-2 row-cols-md-3 row-cols-lg-5 g-4">
			...
			<div class="col">
				<div class="product-card">
					<div class="card-img-container">
						<img
							src="https://img2.joongna.com/media/original/2024/08/24/1724504730088yxM_JmP7T.jpg"
							class="card-img-top" alt="상품 이미지">
						<button class="wish-btn">
					...
					<div class="card-body">
						...
						<div class="card-meta d-flex justify-content-between">
							<span>덕풍1동 | 3분 전</span> <span>찜 3 · 채팅 1</span>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col">
				<div class="product-card">
					<div class="card-img-container">
						<img src="https://asset.m-gs.kr/prod/1069144804/5/550"
							class="card-img-top" alt="상품 이미지">
						<button class="wish-btn">
							<i class="bi bi-heart"></i>
						</button>
					...
					<div class="card-body">
						...
						<div class="card-meta d-flex justify-content-between">
							<span>룡남동 | 20분전</span> <span>찜 3 · 채팅 1</span>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col">
				<div class="product-card">
					<div class="card-img-container">
						<img
							src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRUwevA7g6ZxEUyQ2slu469WxcI8qS0Tl-oSg&s"
							class="card-img-top" alt="상품 이미지">
						<button class="wish-btn">
							<i class="bi bi-heart"></i>
						</button>
					...
					<div class="card-body">
						...
						<div class="card-meta d-flex justify-content-between">
							<span>12분 전</span> <span>찜 3 · 채팅 0</span>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col">
				<div class="product-card">
					<div class="card-img-container">
						<img
							src="https://media.bunjang.co.kr/product/340944073_1_1750653267_w360.jpg"
							class="card-img-top" alt="상품 이미지">
						<button class="wish-btn">
							<i class="bi bi-heart"></i>
						</button>
					...
					<div class="card-body">
						...
						<div class="card-meta d-flex justify-content-between">
							<span>5분 전</span> <span>찜 2 · 채팅 0</span>
						</div>
					</div>
				</div>
			</div>
