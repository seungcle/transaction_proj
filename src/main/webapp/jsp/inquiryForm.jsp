...
<jsp:include page="header.jsp"/>
  ...
  <div class="container mt-4">
    ...
    <p class="text-muted">문의하실 내용을 작성해 주세요. (목업 페이지이며 실제 전송은 이루어지지 않습니다)</p>

    <!-- 목업: submit 시 alert 후 본 페이지로 -->
    <form onsubmit="event.preventDefault(); alert('목업: 문의가 접수되었습니다.'); location.href='./inquiryForm.jsp';">
      <div class="row g-3">
        <div class="col-md-6">
        ...
        <div class="col-12">
          ...
          <textarea class="form-control" rows="8" placeholder="문의 내용을 자세히 입력해 주세요" required></textarea>
        </div>
        <div class="col-12">
