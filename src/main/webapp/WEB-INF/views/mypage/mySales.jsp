...
<body>
    <div class="offcanvas offcanvas-end" tabindex="-1"
        id="mySalesOffcanvas" aria-labelledby="mySalesOffcanvasLabel" data-user-id="${userId}">
        ...
        <div class="p-3" id="saleCompleteListContainer">
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            myPurchasesOffcanvas.addEventListener('show.bs.offcanvas', function () {
                ...
                // 컨테이너를 비워서 중복 로딩 방지
                $('#saleCompleteListContainer').empty();
                ...
                // AJAX 요청 URL 생성
                var requestUrl = "${pageContext.request.contextPath}/item/" + userId + "/sale/end?page=" + page;
