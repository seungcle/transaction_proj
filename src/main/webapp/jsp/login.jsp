...
<head>
  ...
  <!-- 공통/로그인 CSS (global이 먼저, 그 다음 페이지 전용) -->
...
<body>
  ...
  <div class="login-card">
    ...
    <!-- 카카오 로그인 -->
    <a class="btn-social btn-kakao" href="https://nid.kakao.com/oauth2.0/authorize">
      <img class="login-icon" src="${pageContext.request.contextPath}/images/kakao.png" alt="카카오 아이콘">
      카카오로 로그인
    </a>
